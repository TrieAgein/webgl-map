...
export const laScatterLayer = (datasetId) =>
  new ScatterplotLayer({
    id: "scatterplot-layer",
    data:
      datasetId === LAActiveBusiness.id
...
export const nycScatterLayer = (datasetId) =>
  new ScatterplotLayer({
    id: "scatterplot-layer",
    data:
      datasetId === NYCTree1995.id
        ? "https://data.cityofnewyork.us/resource/kyad-zm4j.json"
        : "https://data.cityofnewyork.us/resource/5rq2-4hqu.json?$limit=50000&boroname=Manhattan",
...
export const laHexLayer = (datasetId) =>
  new HexagonLayer({
    id: "hexagon-layer",
    data:
      datasetId === LAActiveBusiness.id
...
export const nycHexLayer = (datasetId) =>
  new HexagonLayer({
    id: "hexagon-layer",
    data:
      datasetId === NYCTree1995.id
...
export const getLayer = (visual, city, dataset) => {
  switch (visual) {
    case "Scatterplot":
      return scatterLayers[city][dataset];
    case "Hexagon":
      return hexLayers[city][dataset];
    default:
      return null;
  }
};
